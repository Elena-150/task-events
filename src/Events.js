...
export function createArrList(arr) {
    ...
    arr.forEach((itemText) => {
        ...
        li.addEventListener('mouseover', () => {
            li.setAttribute('title', itemText);
        });
...
export function createList() {
    ...
    function addListItem() {
        ...
        addNewLiClickHandler(newLi);
    }
    function liClickHandler() {
        this.textContent += '!';
    }
    function addNewLiClickHandler(liElement) {
        liElement.addEventListener('click', liClickHandler);
    }
    addNewLiClickHandler(li);
